...
<html lang="es">
    ...
    <!--############### Comienzo de Header #################-->
                ...
                <div class="container">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-4 text-center align-self-center p-1">
                      <ul class="navbar-nav collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                        ...
                        <li>
                          <a class="nav-link align-self-center" href="./libros.php" style="font-size: 15px;">Libros</a>
                        </li>
                        <li>
        ...
        <div class="container">
            ...
            <?php librosCurso($conexion,$_SESSION["usuario"]); ?>
            <hr>
            <?php librosFinalizados($conexion,$_SESSION["usuario"]); ?>
